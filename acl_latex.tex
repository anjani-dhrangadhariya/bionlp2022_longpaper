...
Additionally, we plan to explore the quality of DISTANT-CTO if $d_s$ score is lower than 0.9.
%
\begin{table}[ht]
    \centering
    \begin{tabular}{l|r}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.90\columnwidth]{figures/mapped_unmapped_cmyk.jpeg}
...
\begin{figure*}[hbt!]
\centering
\includegraphics[width=0.90\textwidth]{figures/mention_lengths_distribution_cmyk.jpeg}
